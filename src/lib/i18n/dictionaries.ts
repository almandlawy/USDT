...
const ar = {
  ...
  dashboard: { greeting: "مرحباً", overview: "نظرة عامة", profile: "الملف الشخصي", kyc: "التحقق KYC", buy: "طلب شراء", sell: "طلب بيع", p2p: "سوق P2P", proofs: "إثباتات الدفع", orders: "سجل الطلبات", support: "الدعم", notifications: "الإشعارات", security: "الأمان و2FA", signout: "تسجيل الخروج" },
  admin: { title: "مركز العمليات", dashboard: "لوحة الإدارة", customers: "العملاء", kyc: "مراجعات KYC", buyOrders:"طلبات الشراء",sellOrders:"طلبات البيع",p2p: "طلبات P2P", proofs: "إثباتات الدفع", paymentMethods: "طرق الدفع", rates:"الأسعار",fees:"الرسوم",limits:"الحدود",wallets:"عناوين المحافظ", compliance: "تنبيهات الامتثال",disputes:"النزاعات", support: "الدعم",notifications:"الإشعارات", staff: "الموظفون",roles:"الصلاحيات", audit: "سجل التدقيق",legal:"المحتوى القانوني", settings: "الإعدادات",flags:"Feature flags" },
};
