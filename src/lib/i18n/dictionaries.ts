...
const ar = {
  ...
  admin: { title: "مركز العمليات", dashboard: "لوحة الإدارة", ops: "غرفة العمليات", customers: "العملاء", kyc: "مراجعات KYC", buyOrders:"طلبات الشراء",sellOrders:"طلبات البيع",p2p: "طلبات P2P", proofs: "إثباتات الدفع", paymentMethods: "طرق الدفع", rates:"الأسعار",fees:"الرسوم",limits:"الحدود",wallets:"عناوين المحافظ", compliance: "تنبيهات الامتثال",disputes:"النزاعات", support: "الدعم",notifications:"الإشعارات", staff: "الموظفون",roles:"الصلاحيات", audit: "سجل التدقيق",legal:"المحتوى القانوني", settings: "الإعدادات",flags:"Feature flags" },
};
