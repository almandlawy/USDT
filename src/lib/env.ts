...
const publicSchema = z.object({
  ...
  NEXT_PUBLIC_COMPANY_REFERENCE: optionalNonEmpty,
  ...
  NEXT_PUBLIC_SUPPORT_PHONE: optionalNonEmpty,
  ...
  NEXT_PUBLIC_VARA_LICENSE_NUMBER: optionalNonEmpty,
  NEXT_PUBLIC_VARA_LICENSE_TYPE: optionalNonEmpty,
  NEXT_PUBLIC_VARA_LICENSE_STATUS: optionalNonEmpty,
  NEXT_PUBLIC_VARA_LICENSED_ACTIVITIES: optionalNonEmpty,
...
const serverSchema = publicSchema.extend({
  ...
  COMPANY_LEGAL_DETAILS_VERIFIED: booleanString.default(false),
  COMPANY_VERIFIED_LEGAL_ADDRESS_DRAFT: optionalNonEmpty,
...
export const publicEnv = publicSchema.parse({
  ...
  NEXT_PUBLIC_COMPANY_REFERENCE: process.env.NEXT_PUBLIC_COMPANY_REFERENCE,
  ...
  NEXT_PUBLIC_VARA_LICENSE_NUMBER: process.env.NEXT_PUBLIC_VARA_LICENSE_NUMBER,
  NEXT_PUBLIC_VARA_LICENSE_TYPE: process.env.NEXT_PUBLIC_VARA_LICENSE_TYPE,
  NEXT_PUBLIC_VARA_LICENSE_STATUS: process.env.NEXT_PUBLIC_VARA_LICENSE_STATUS,
  NEXT_PUBLIC_VARA_LICENSED_ACTIVITIES: process.env.NEXT_PUBLIC_VARA_LICENSED_ACTIVITIES,
  NEXT_PUBLIC_VARA_LICENSE_VALID_FROM: process.env.NEXT_PUBLIC_VARA_LICENSE_VALID_FROM,
  NEXT_PUBLIC_VARA_LICENSE_VALID_TO: process.env.NEXT_PUBLIC_VARA_LICENSE_VALID_TO,
